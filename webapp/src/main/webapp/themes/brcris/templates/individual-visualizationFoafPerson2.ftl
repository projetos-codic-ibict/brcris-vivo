...
<#if (isAuthor || isInvestigator)>
    ...
    <#assign standardVisualizationURLRoot ="/visualization">
        ...
        <#if isAuthor>
            ...
            <div id="fullstats_link_container" class="collaboratorship-link-container">
              <div class="collaboratorship-icon">
                  <a href="${prodFullStatsVisUrl}" title="Publications Full Stats"><img src="${fullPub}" alt="Publications Full Stats" width="25px" height="25px" /></a>
              </div>
              <div class="collaboratorship-link"><a href="${prodFullStatsVisUrl}" title="${i18n().publications_in_vivo}">Publications Full Stats</a></div>
            </div>
		...
		<#assign prodAreasIcon = "${urls.theme}/images/production-areas-icon.png">
        	<div class="collaboratorship-icon">
                    <a href="${prodResAreaVisUrl}" title="Production Areas"><img src="${prodAreasIcon}" alt="Production Areas" width="25px" height="25px" /></a>
                </div>
