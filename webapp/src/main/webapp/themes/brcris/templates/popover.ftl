...
<button type="button" id="data-info" class="btn btn-outline-secondary" data-bs-toggle="popover" data-placement="bottom"   title="${i18n().data_source_title}"  data-bs-content="Os dados para geração deste gráfico são coletados de várias fontes de pesquisa. Para mais informações, <a href='http://codich1.ibict.br:8086/data-source-info'>clique aqui</a>.">
